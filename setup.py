...
positional_encoding_extension = CUDAExtension(
    name="paceserve.pos_encoding_ops",
...
setuptools.setup(
    name="paceserve",
    version=find_version(get_path("paceserve", "__init__.py")),
    author="Azam and Xiang",
    license="Apache 2.0",
    description=("Priority adaptive efficient LLM inference"),
