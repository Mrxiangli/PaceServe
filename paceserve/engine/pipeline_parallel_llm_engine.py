...
from paceserve.core.datatypes.sequence import SamplerOutputs, SequenceMetadata
...
class PipelineParallelLLMEngine(BaseLLMEngine):
    ...
    def _get_worker_impl(self):
        ...
        from paceserve.worker.pipeline_parallel_worker import PipelineParallelWorker
