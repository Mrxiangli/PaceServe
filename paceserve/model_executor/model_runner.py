...
from paceserve.config import SchedulerType, SystemConfig
...
from paceserve.model_executor import get_model, set_random_seed
from paceserve.model_executor.attention.attention_backend_registry import (
    AttentionBackendRegistry,
)
from paceserve.model_executor.attention.base_attention_wrapper import BaseAttentionWrapper
from paceserve.model_executor.layers.sampler import Sampler
from paceserve.model_executor.utils import pad_to_alignment
from paceserve.utils import get_gpu_memory
    ...
    def __init__(
        ...
        if self.model.lm_head:
            self.sampler = Sampler(
                self.model.lm_head.weight, self.model.config.vocab_size, self.config.controller_config.use_logits
            )
