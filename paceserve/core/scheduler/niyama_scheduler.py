...
class NiyamaScheduler(BaseScheduler):

    def __init__(
        self,
        engine_type: InstanceType,
        model_config: ModelConfig,
        scheduler_config: NiyamaSchedulerConfig,
    ...
    def _schedule(self) -> SchedulerOutputs:
        ...
        while self.running:
            ...
            # find the decode request with minimum slack
            if seq.state._last_token_generated_at <= minimum_slack:
                seq.state._last_token_generated_at
        ...
        for seq in running_prefills:
            ...
            running.append(seq)
            batch.add_request(PrefillRequest(seq, chunk_size=next_num_prefill_tokens))
