...
from paceserve.config import ReplicaConfig
from paceserve.metrics.metrics_store import MetricsStore
from paceserve.types import ReplicaResourceMapping, ResourceMapping
...
class BenchmarkRunnerLauncher:
    ...
    def _get_replica_resource_mapping(self) -> ReplicaResourceMapping:
        ...
        print(f"ray available resource: {ray.available_resources()}")
        print(f"cluster resource: {cluster_resources_keys}")
